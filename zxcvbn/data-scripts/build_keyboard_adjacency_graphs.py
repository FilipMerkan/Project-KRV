...
# Main difference from QWERTY: Z and Y are swapped
# Includes Slovenian-specific characters: č, š, ž, ć, đ
qwertz_slovenian = r'''
`~ 1! 2" 3# 4$ 5% 6& 7/ 8( 9) 0= '? +*
    qQ wW eE rR tT zZ uU iI oO pP šŠ đĐ
     aA sS dD fF gG hH jJ kK lL čČ ćĆ
...
def build_graph(layout_str, slanted):
    ...
    * on keypad layout, '7' maps to [None, None, None, '=', '8', '5', '4', None]
    ...
    adjacency_graph = {}
    for (x,y), chars in iteritems(position_table):
        for char in chars:
...
if __name__ == '__main__':
    ...
    with open(sys.argv[1], 'w') as f:
        ...
        for graph_name, args in [('qwerty', (qwerty, True)),
                                 ('dvorak', (dvorak, True)),
                                 ('qwertz_slovenian', (qwertz_slovenian, True)),
                                 ('keypad', (keypad, False)),
